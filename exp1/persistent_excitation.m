...
t = channel.Test_Time_s; % test times
u = channel.Current_A; % current (input) data
y = channel.Voltage_V; % voltage (output) data
...
title('Order of Persistent Excitation for Client Data', 'FontSize', font);