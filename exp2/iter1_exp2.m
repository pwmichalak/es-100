%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                                                                    %
% First Iteration Project Build: Experiment 2 (Sensitivity Analysis) %
%                                                                    %
...
% the time constant is on the order of 1e2; we must not go beneath
% the cutoff frequency of the system, which is 1/2time constant = 5e-3
fsvals = [1e-2 1e-1 1 1e1 1e2];
n = 1000;
...
title('MSE as a Function of Memory Factor, Iteration 1', 'FontSize', font);
...
for i = 1:5
    ...
    title(strcat(names(i),"Parameter Error as a Function of Memory Factor, Iteration 1"), 'FontSize', font);
