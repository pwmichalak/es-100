%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                                                                    %
% Second Iteration Project Build: Experiment 2                       %
%                                                                    %
...
for rmsy = rms_valsy
    for rmsu = rms_valsu
        ...
        [r0p, r1p, r2p, c1p, c2p, sysc_build, sysd_build, mse] = build_iter2(u_u,y_y,p,order,Ts);
...
for fs = fsvals
    ...
    p = randi([4 5],1) * order; % memory factor; should be 4-5 times the order
    [r0p, r1p, r2p, c1p, c2p, sysc_build, sysd_build, mse] = build_iter2(u,y,p,order,Ts);
...
title('MSE as a Function of Memory Factor, Iteration 2', 'FontSize', font);
...
for i = 1:5
    ...
    title(strcat(names(i),"Parameter Error as a Function of Memory Factor, Iteration 2"), 'FontSize', font);
