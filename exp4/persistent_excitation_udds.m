% check for persistent excitation (at every order) of UDDS data
clear; close all;

% obtain UDDS data
channel = get_data('data/udds-Wang-Liu-Pan-Chen-2017.xlsx','Sheet1');
channel.SampleTime = [];
...
title('Order of Persistent Excitation for UDDS data', 'FontSize', font);
